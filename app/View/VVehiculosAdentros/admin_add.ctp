...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-12">
		...
		<div class="vVehiculosAdentros form p_form">
		
			<?php echo $this->Form->create('VVehiculosAdentro', array('inputDefaults' => array('label' => false), 'role' => 'form')); ?>
				<fieldset>
					<h2><?php echo __('Agregar V Vehiculos Adentro'); ?>										</h2>
				<hr />
					<div class="row">
						...
						<div class="form-group col-sm-4" style="font-weight: bold;">
													<?php echo $persona['Persona']['virtual']?>							<?php echo $this->Form->input('persona_id', array('div' => false,'type' => 'hidden', 'value'=> $persona['Persona']['id'])); ?>	
												</div>
					</div>
