...
<div id="page-container" class="row">
	...
	<div id="page-content" class="col-sm-12">
		...
		<div class="personas form p_form">
			...
			<?php echo $this->Form->create('Persona', array('inputDefaults' => array('label' => false), 'role' => 'form')); ?>
				<fieldset>
					<h2><?php echo __('Editar Persona'); ?>										</h2>
				<hr />
	...
	<?php endforeach; ?>
				...
				<div class="actions">
					<?php echo $this->Html->link('<i class="icon-plus icon-white"></i> '.__('Nuevo Movimiento'), array('controller' => 'movimientos', 'action' => 'add',h($this->data['Persona']['id'])),array('class' => 'btn btn-primary', 'escape' => false)); ?>				</div><!-- /.actions -->
