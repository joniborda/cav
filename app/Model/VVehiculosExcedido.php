 ...
 */
class VVehiculosExcedido extends AppModel {
...
public $actsAs = array('Search.Searchable');
	...
	public $filterArgs = array(
		'vehiculo_id' => array('type' => 'subquery', 'method' => 'searchVehiculo_id', 'field' => '"VVehiculosExcedido"."vehiculo_id"', 'encode' => true),
		'patente' => array('type' => 'expression', 'method' => 'searchPatente', 'field' => '"VVehiculosExcedido"."patente"::text ILIKE ?', 'encode' => true),
		'tipo_autorizacion' => array('type' => 'expression', 'method' => 'searchTipo_autorizacion', 'field' => '"VVehiculosExcedido"."tipo_autorizacion"::text ILIKE ?', 'encode' => true),
		'movimiento_id' => array('type' => 'subquery', 'method' => 'searchMovimiento_id', 'field' => '"VVehiculosExcedido"."movimiento_id"', 'encode' => true),
		'persona_id' => array('type' => 'subquery', 'method' => 'searchPersona_id', 'field' => '"VVehiculosExcedido"."persona_id"', 'encode' => true),
		'sector' => array('type' => 'expression', 'method' => 'searchSector', 'field' => '"VVehiculosExcedido"."sector"::text ILIKE ?', 'encode' => true),
		'interno' => array('type' => 'expression', 'method' => 'searchInterno', 'field' => '"VVehiculosExcedido"."interno"::text ILIKE ?', 'encode' => true),
		'fecha_carga' => array('type' => 'expression', 'method' => 'searchFecha_carga', 'field' => '"VVehiculosExcedido"."fecha_carga"::text ILIKE ?', 'encode' => true),
		'usuario_id' => array('type' => 'subquery', 'method' => 'searchUsuario_id', 'field' => '"VVehiculosExcedido"."usuario_id"', 'encode' => true),
	);
